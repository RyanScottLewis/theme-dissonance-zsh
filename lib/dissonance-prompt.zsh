...
# -- ANSI ---------------------------------------------------------------------------------------- #
# Set terminal ANSI colors below to the before for best results

THEME_PALETTE_BLACK=000          # #1c1c1c
THEME_PALETTE_BLACK_BRIGHT=008   # #686868
THEME_PALETTE_RED=001            # #d71e00
THEME_PALETTE_RED_BRIGHT=009     # #ff3121
THEME_PALETTE_GREEN=002          # #ced074
THEME_PALETTE_GREEN_BRIGHT=010   # #a1d24d
THEME_PALETTE_YELLOW=003         # #ff8700
THEME_PALETTE_YELLOW_BRIGHT=011  # #ffd787
THEME_PALETTE_BLUE=004           # #0087d7
THEME_PALETTE_BLUE_BRIGHT=012    # #a0cdff
THEME_PALETTE_MAGENTA=005        # #cc6ece
THEME_PALETTE_MAGENTA_BRIGHT=013 # #fb40ff
THEME_PALETTE_CYAN=006           # #87d7ff
THEME_PALETTE_CYAN_BRIGHT=014    # #c0eaff
THEME_PALETTE_WHITE=007          # #e0e0e0
THEME_PALETTE_WHITE_BRIGHT=015   # #ffffff
...
THEME_COLOR_KEYMAP_PROMPT_VI_COMMAND_BACKGROUND=$THEME_PALETTE_GREEN
...
function theme_update_state() {
  ...
  if [ $THEME_PROMPT_KEYMAP_CURRENT = $THEME_PROMPT_KEYMAP_VI_COMMAND ]; then
    THEME_STATE_PROMPT_LEFT[full]="$THEME_STATE_PROMPT_LEFT[full]%K{$THEME_COLOR_KEYMAP_PROMPT_VI_COMMAND_BACKGROUND}"
    THEME_STATE_PROMPT_RIGHT[full]="%k$THEME_STATE_PROMPT_RIGHT[full]"
  fi
